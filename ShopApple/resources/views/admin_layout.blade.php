...
<head>
  ...
  <link rel="icon" type="image/png" href="{{ asset('/BE/img/icons8-admin-50.png') }}">
  <title>
    Admin
  </title>
  <!--     Fonts and icons     -->
...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="{{ URL::to('/dashboard') }}">
        <img src="{{ asset('/FE/img/core-img/icons8-apple-30.png') }}" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">ShopApple</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{ URL::to('/all-category-product') }}">
            ...
            <a class="nav-link collapsed" href="{{ URL::to('/add-category-product') }}">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{ URL::to('/all-brand-product')}}">
            ...
            <span class="nav-link-text ms-1">Brand Product</span>
                <a class="nav-link collapsed" href="{{ URL::to('/add-brand-product') }}">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Add Brand</span>
                </a>
          </a>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{ URL::to('/all-product') }}">
            ...
            <a class="nav-link collapsed" href="{{ URL::to('/add-product') }}">
                    <i class="fas fa-fw fa-cog"></i>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{ URL::to('/list-coupon') }}">
            ...
            <span class="nav-link-text ms-1">Manage Coupon</span>
            <a class="nav-link collapsed" href="{{ URL::to('/insert-coupon') }}">
                  <i class="fas fa-fw fa-cog"></i>
  ...
  <script src="{{ asset('/BE/js/soft-ui-dashboard.min.js') }}"></script>
</body>
